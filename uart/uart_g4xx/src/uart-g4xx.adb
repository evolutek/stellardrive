...
package body UART.G4xx is
    ...
    procedure wait_tx(Self : UART_Port_G4xx) is
    begin
        loop
    ...
    function wait_rx(Self : UART_Port_G4xx; timeout : Integer := 1000) return Boolean is
    ...
    overriding procedure write(Self : in out UART_Port_G4xx; data : UART_Data_8b) is
        result : UART_Status;
    begin
        wait_tx (Self);
    ...
    overriding function available(Self : in out UART_Port_G4xx) return Boolean is
    begin
        return USARTs.Rx_Ready (Self.port.all);
    end available;
    ...
    overriding procedure write(Self : in out UART_Port_G4xx; str : String) is
    ...
    overriding procedure print(Self : in out UART_Port_G4xx; str : String) is
    begin
        write (Self, str);

...
package STM32_SVD.FMAC is
   ...
   subtype PARAM_START_Field is Boolean;
   ...
   subtype CR_RIEN_Field is Boolean;
   subtype CR_WIEN_Field is Boolean;
   subtype CR_OVFLIEN_Field is Boolean;
   subtype CR_UNFLIEN_Field is Boolean;
   subtype CR_SATIEN_Field is Boolean;
   subtype CR_DMAREN_Field is Boolean;
   subtype CR_DMAWEN_Field is Boolean;
   subtype CR_CLIPEN_Field is Boolean;
   subtype CR_RESET_Field is Boolean;

   --  FMAC Control register
   type CR_Register is record
      --  RIEN
      RIEN           : CR_RIEN_Field := False;
      --  WIEN
      WIEN           : CR_WIEN_Field := False;
      --  OVFLIEN
      OVFLIEN        : CR_OVFLIEN_Field := False;
      --  UNFLIEN
      UNFLIEN        : CR_UNFLIEN_Field := False;
      --  SATIEN
      SATIEN         : CR_SATIEN_Field := False;
      --  unspecified
      Reserved_5_7   : HAL.UInt3 := 16#0#;
      --  DMAREN
      DMAREN         : CR_DMAREN_Field := False;
      --  DMAWEN
      DMAWEN         : CR_DMAWEN_Field := False;
      --  unspecified
      Reserved_10_14 : HAL.UInt5 := 16#0#;
      --  CLIPEN
      CLIPEN         : CR_CLIPEN_Field := False;
      --  RESET
      RESET          : CR_RESET_Field := False;
      --  unspecified
   ...
   subtype SR_YEMPTY_Field is Boolean;
   subtype SR_X1FULL_Field is Boolean;
   subtype SR_OVFL_Field is Boolean;
   subtype SR_UNFL_Field is Boolean;
   subtype SR_SAT_Field is Boolean;

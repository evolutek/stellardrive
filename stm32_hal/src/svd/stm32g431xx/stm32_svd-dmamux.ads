...
package STM32_SVD.DMAMUX is
   ...
   subtype C0CR_SOIE_Field is Boolean;
   subtype C0CR_EGE_Field is Boolean;
   subtype C0CR_SE_Field is Boolean;
   ...
   subtype C1CR_SOIE_Field is Boolean;
   subtype C1CR_EGE_Field is Boolean;
   subtype C1CR_SE_Field is Boolean;
   ...
   type C1CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C1CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C1CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C1CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C2CR_SOIE_Field is Boolean;
   subtype C2CR_EGE_Field is Boolean;
   subtype C2CR_SE_Field is Boolean;
   ...
   type C2CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C2CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C2CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C2CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C3CR_SOIE_Field is Boolean;
   subtype C3CR_EGE_Field is Boolean;
   subtype C3CR_SE_Field is Boolean;
   ...
   type C3CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C3CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C3CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C3CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C4CR_SOIE_Field is Boolean;
   subtype C4CR_EGE_Field is Boolean;
   subtype C4CR_SE_Field is Boolean;
   ...
   type C4CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C4CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C4CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C4CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C5CR_SOIE_Field is Boolean;
   subtype C5CR_EGE_Field is Boolean;
   subtype C5CR_SE_Field is Boolean;
   ...
   type C5CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C5CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C5CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C5CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C6CR_SOIE_Field is Boolean;
   subtype C6CR_EGE_Field is Boolean;
   subtype C6CR_SE_Field is Boolean;
   ...
   type C6CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C6CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C6CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C6CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C7CR_SOIE_Field is Boolean;
   subtype C7CR_EGE_Field is Boolean;
   subtype C7CR_SE_Field is Boolean;
   ...
   type C7CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C7CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C7CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C7CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C8CR_SOIE_Field is Boolean;
   subtype C8CR_EGE_Field is Boolean;
   subtype C8CR_SE_Field is Boolean;
   ...
   type C8CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C8CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C8CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C8CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C9CR_SOIE_Field is Boolean;
   subtype C9CR_EGE_Field is Boolean;
   subtype C9CR_SE_Field is Boolean;
   ...
   type C9CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C9CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C9CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C9CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C10CR_SOIE_Field is Boolean;
   subtype C10CR_EGE_Field is Boolean;
   subtype C10CR_SE_Field is Boolean;
   ...
   type C10CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C10CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C10CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C10CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C11CR_SOIE_Field is Boolean;
   subtype C11CR_EGE_Field is Boolean;
   subtype C11CR_SE_Field is Boolean;
   ...
   type C11CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C11CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C11CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C11CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C12CR_SOIE_Field is Boolean;
   subtype C12CR_EGE_Field is Boolean;
   subtype C12CR_SE_Field is Boolean;
   ...
   type C12CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C12CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C12CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C12CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C13CR_SOIE_Field is Boolean;
   subtype C13CR_EGE_Field is Boolean;
   subtype C13CR_SE_Field is Boolean;
   ...
   type C13CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C13CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C13CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C13CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C14CR_SOIE_Field is Boolean;
   subtype C14CR_EGE_Field is Boolean;
   subtype C14CR_SE_Field is Boolean;
   ...
   type C14CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C14CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C14CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C14CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype C15CR_SOIE_Field is Boolean;
   subtype C15CR_EGE_Field is Boolean;
   subtype C15CR_SE_Field is Boolean;
   ...
   type C15CR_Register is record
      ...
      Reserved_7_7   : Boolean := False;
      --  Interrupt enable at synchronization event overrun
      SOIE           : C15CR_SOIE_Field := False;
      --  Event generation enable/disable
      EGE            : C15CR_EGE_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Synchronous operating mode enable/disable
      SE             : C15CR_SE_Field := False;
      --  Synchronization event type selector Defines the synchronization event
      --  on the selected synchronization input:
   ...
   subtype RG0CR_OIE_Field is Boolean;
   subtype RG0CR_GE_Field is Boolean;
   ...
   subtype RG1CR_OIE_Field is Boolean;
   subtype RG1CR_GE_Field is Boolean;
   ...
   type RG1CR_Register is record
      ...
      Reserved_5_7   : HAL.UInt3 := 16#0#;
      --  Interrupt enable at trigger event overrun
      OIE            : RG1CR_OIE_Field := False;
      --  unspecified
      Reserved_9_15  : HAL.UInt7 := 16#0#;
      --  DMA request generator channel enable/disable
      GE             : RG1CR_GE_Field := False;
      --  DMA request generator trigger event type selection Defines the
      --  trigger event on the selected DMA request trigger input
   ...
   subtype RG2CR_OIE_Field is Boolean;
   subtype RG2CR_GE_Field is Boolean;
   ...
   type RG2CR_Register is record
      ...
      Reserved_5_7   : HAL.UInt3 := 16#0#;
      --  Interrupt enable at trigger event overrun
      OIE            : RG2CR_OIE_Field := False;
      --  unspecified
      Reserved_9_15  : HAL.UInt7 := 16#0#;
      --  DMA request generator channel enable/disable
      GE             : RG2CR_GE_Field := False;
      --  DMA request generator trigger event type selection Defines the
      --  trigger event on the selected DMA request trigger input
   ...
   subtype RG3CR_OIE_Field is Boolean;
   subtype RG3CR_GE_Field is Boolean;
   ...
   type RG3CR_Register is record
      ...
      Reserved_5_7   : HAL.UInt3 := 16#0#;
      --  Interrupt enable at trigger event overrun
      OIE            : RG3CR_OIE_Field := False;
      --  unspecified
      Reserved_9_15  : HAL.UInt7 := 16#0#;
      --  DMA request generator channel enable/disable
      GE             : RG3CR_GE_Field := False;
      --  DMA request generator trigger event type selection Defines the
      --  trigger event on the selected DMA request trigger input

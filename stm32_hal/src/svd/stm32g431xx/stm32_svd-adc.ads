...
package STM32_SVD.ADC is
   ...
   subtype ISR_ADRDY_Field is Boolean;
   subtype ISR_EOSMP_Field is Boolean;
   subtype ISR_EOC_Field is Boolean;
   subtype ISR_EOS_Field is Boolean;
   subtype ISR_OVR_Field is Boolean;
   subtype ISR_JEOC_Field is Boolean;
   subtype ISR_JEOS_Field is Boolean;
   --  ISR_AWD array element
   subtype ISR_AWD_Element is Boolean;
   ...
   subtype ISR_JQOVF_Field is Boolean;

   --  interrupt and status register
   type ISR_Register is record
      --  ADRDY
      ADRDY          : ISR_ADRDY_Field := False;
      --  EOSMP
      EOSMP          : ISR_EOSMP_Field := False;
      --  EOC
      EOC            : ISR_EOC_Field := False;
      --  EOS
      EOS            : ISR_EOS_Field := False;
      --  OVR
      OVR            : ISR_OVR_Field := False;
      --  JEOC
      JEOC           : ISR_JEOC_Field := False;
      --  JEOS
      JEOS           : ISR_JEOS_Field := False;
      --  AWD1
      AWD            : ISR_AWD_Field := (As_Array => False, Val => 16#0#);
      --  JQOVF
      JQOVF          : ISR_JQOVF_Field := False;
      --  unspecified
   ...
   subtype IER_ADRDYIE_Field is Boolean;
   subtype IER_EOSMPIE_Field is Boolean;
   subtype IER_EOCIE_Field is Boolean;
   subtype IER_EOSIE_Field is Boolean;
   subtype IER_OVRIE_Field is Boolean;
   subtype IER_JEOCIE_Field is Boolean;
   subtype IER_JEOSIE_Field is Boolean;
   subtype IER_AWD1IE_Field is Boolean;
   subtype IER_AWD2IE_Field is Boolean;
   subtype IER_AWD3IE_Field is Boolean;
   subtype IER_JQOVFIE_Field is Boolean;

   --  interrupt enable register
   type IER_Register is record
      --  ADRDYIE
      ADRDYIE        : IER_ADRDYIE_Field := False;
      --  EOSMPIE
      EOSMPIE        : IER_EOSMPIE_Field := False;
      --  EOCIE
      EOCIE          : IER_EOCIE_Field := False;
      --  EOSIE
      EOSIE          : IER_EOSIE_Field := False;
      --  OVRIE
      OVRIE          : IER_OVRIE_Field := False;
      --  JEOCIE
      JEOCIE         : IER_JEOCIE_Field := False;
      --  JEOSIE
      JEOSIE         : IER_JEOSIE_Field := False;
      --  AWD1IE
      AWD1IE         : IER_AWD1IE_Field := False;
      --  AWD2IE
      AWD2IE         : IER_AWD2IE_Field := False;
      --  AWD3IE
      AWD3IE         : IER_AWD3IE_Field := False;
      --  JQOVFIE
      JQOVFIE        : IER_JQOVFIE_Field := False;
      --  unspecified
      Reserved_11_31 : HAL.UInt21 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CR_ADEN_Field is Boolean;
   subtype CR_ADDIS_Field is Boolean;
   subtype CR_ADSTART_Field is Boolean;
   subtype CR_JADSTART_Field is Boolean;
   subtype CR_ADSTP_Field is Boolean;
   subtype CR_JADSTP_Field is Boolean;
   subtype CR_ADVREGEN_Field is Boolean;
   subtype CR_DEEPPWD_Field is Boolean;
   subtype CR_ADCALDIF_Field is Boolean;
   subtype CR_ADCAL_Field is Boolean;

   --  control register
   type CR_Register is record
      --  ADEN
      ADEN          : CR_ADEN_Field := False;
      --  ADDIS
      ADDIS         : CR_ADDIS_Field := False;
      --  ADSTART
      ADSTART       : CR_ADSTART_Field := False;
      --  JADSTART
      JADSTART      : CR_JADSTART_Field := False;
      --  ADSTP
      ADSTP         : CR_ADSTP_Field := False;
      --  JADSTP
      JADSTP        : CR_JADSTP_Field := False;
      --  unspecified
      Reserved_6_27 : HAL.UInt22 := 16#0#;
      --  ADVREGEN
      ADVREGEN      : CR_ADVREGEN_Field := False;
      --  DEEPPWD
      DEEPPWD       : CR_DEEPPWD_Field := True;
      --  ADCALDIF
      ADCALDIF      : CR_ADCALDIF_Field := False;
      --  ADCAL
      ADCAL         : CR_ADCAL_Field := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CFGR_DMAEN_Field is Boolean;
   subtype CFGR_DMACFG_Field is Boolean;
   subtype CFGR_RES_Field is HAL.UInt2;
   subtype CFGR_EXTSEL_Field is HAL.UInt5;
   subtype CFGR_EXTEN_Field is HAL.UInt2;
   subtype CFGR_OVRMOD_Field is Boolean;
   subtype CFGR_CONT_Field is Boolean;
   subtype CFGR_AUTDLY_Field is Boolean;
   subtype CFGR_ALIGN_Field is Boolean;
   subtype CFGR_DISCEN_Field is Boolean;
   subtype CFGR_DISCNUM_Field is HAL.UInt3;
   subtype CFGR_JDISCEN_Field is Boolean;
   subtype CFGR_JQM_Field is Boolean;
   subtype CFGR_AWD1SGL_Field is Boolean;
   subtype CFGR_AWD1EN_Field is Boolean;
   subtype CFGR_JAWD1EN_Field is Boolean;
   subtype CFGR_JAUTO_Field is Boolean;
   subtype CFGR_AWD1CH_Field is HAL.UInt5;
   subtype CFGR_JQDIS_Field is Boolean;

   --  configuration register
   type CFGR_Register is record
      --  DMAEN
      DMAEN        : CFGR_DMAEN_Field := False;
      --  DMACFG
      DMACFG       : CFGR_DMACFG_Field := False;
      --  unspecified
      ...
      --  OVRMOD
      OVRMOD       : CFGR_OVRMOD_Field := False;
      --  CONT
      CONT         : CFGR_CONT_Field := False;
      --  AUTDLY
      AUTDLY       : CFGR_AUTDLY_Field := False;
      --  ALIGN
      ALIGN        : CFGR_ALIGN_Field := False;
      --  DISCEN
      DISCEN       : CFGR_DISCEN_Field := False;
      --  DISCNUM
      DISCNUM      : CFGR_DISCNUM_Field := 16#0#;
      --  JDISCEN
      JDISCEN      : CFGR_JDISCEN_Field := False;
      --  JQM
      JQM          : CFGR_JQM_Field := False;
      --  AWD1SGL
      AWD1SGL      : CFGR_AWD1SGL_Field := False;
      --  AWD1EN
      AWD1EN       : CFGR_AWD1EN_Field := False;
      --  JAWD1EN
      JAWD1EN      : CFGR_JAWD1EN_Field := False;
      --  JAUTO
      JAUTO        : CFGR_JAUTO_Field := False;
      --  Analog watchdog 1 channel selection
      AWD1CH       : CFGR_AWD1CH_Field := 16#0#;
      --  Injected Queue disable
      JQDIS        : CFGR_JQDIS_Field := True;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CFGR2_ROVSE_Field is Boolean;
   subtype CFGR2_JOVSE_Field is Boolean;
   subtype CFGR2_OVSR_Field is HAL.UInt3;
   subtype CFGR2_OVSS_Field is HAL.UInt4;
   subtype CFGR2_TROVS_Field is Boolean;
   subtype CFGR2_ROVSM_Field is Boolean;
   subtype CFGR2_GCOMP_Field is Boolean;
   subtype CFGR2_SWTRIG_Field is Boolean;
   subtype CFGR2_BULB_Field is Boolean;
   subtype CFGR2_SMPTRIG_Field is Boolean;

   --  configuration register
   type CFGR2_Register is record
      --  DMAEN
      ROVSE          : CFGR2_ROVSE_Field := False;
      --  DMACFG
      JOVSE          : CFGR2_JOVSE_Field := False;
      --  RES
      OVSR           : CFGR2_OVSR_Field := 16#0#;
      --  ALIGN
      OVSS           : CFGR2_OVSS_Field := 16#0#;
      --  Triggered Regular Oversampling
      TROVS          : CFGR2_TROVS_Field := False;
      --  EXTEN
      ROVSM          : CFGR2_ROVSM_Field := False;
      --  unspecified
      Reserved_11_15 : HAL.UInt5 := 16#0#;
      --  GCOMP
      GCOMP          : CFGR2_GCOMP_Field := False;
      --  unspecified
      Reserved_17_24 : HAL.UInt8 := 16#0#;
      --  SWTRIG
      SWTRIG         : CFGR2_SWTRIG_Field := False;
      --  BULB
      BULB           : CFGR2_BULB_Field := False;
      --  SMPTRIG
      SMPTRIG        : CFGR2_SMPTRIG_Field := False;
      --  unspecified
   ...
   subtype SMPR1_SMPPLUS_Field is Boolean;
   ...
   type SMPR1_Register is record
      ...
      --  unspecified
      Reserved_30_30 : Boolean := False;
      --  Addition of one clock cycle to the sampling time
      SMPPLUS        : SMPR1_SMPPLUS_Field := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type JSQR_Register is record
      ...
      --  unspecified
      Reserved_20_20 : Boolean := False;
      --  JSQ3
      JSQ3           : JSQR_JSQ3_Field := 16#0#;
      --  unspecified
      Reserved_26_26 : Boolean := False;
      --  JSQ4
   ...
   subtype OFR_OFFSETPOS_Field is Boolean;
   subtype OFR_SATEN_Field is Boolean;
   subtype OFR_OFFSET1_CH_Field is HAL.UInt5;
   subtype OFR_OFFSET1_EN_Field is Boolean;
   ...
   type OFR_Register is record
      ...
      --  OFFSETPOS
      OFFSETPOS      : OFR_OFFSETPOS_Field := False;
      --  SATEN
      SATEN          : OFR_SATEN_Field := False;
      --  OFFSET1_CH
      OFFSET1_CH     : OFR_OFFSET1_CH_Field := 16#0#;
      --  OFFSET1_EN
      OFFSET1_EN     : OFR_OFFSET1_EN_Field := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DIFSEL_DIFSEL_0_Field is Boolean;
   ...
   type DIFSEL_Register is record
      ...
      DIFSEL_0       : DIFSEL_DIFSEL_0_Field := False;
   ...
   subtype CSR_ADDRDY_MST_Field is Boolean;
   subtype CSR_EOSMP_MST_Field is Boolean;
   subtype CSR_EOC_MST_Field is Boolean;
   subtype CSR_EOS_MST_Field is Boolean;
   subtype CSR_OVR_MST_Field is Boolean;
   subtype CSR_JEOC_MST_Field is Boolean;
   subtype CSR_JEOS_MST_Field is Boolean;
   subtype CSR_AWD1_MST_Field is Boolean;
   subtype CSR_AWD2_MST_Field is Boolean;
   subtype CSR_AWD3_MST_Field is Boolean;
   subtype CSR_JQOVF_MST_Field is Boolean;
   subtype CSR_ADRDY_SLV_Field is Boolean;
   subtype CSR_EOSMP_SLV_Field is Boolean;
   subtype CSR_EOC_SLV_Field is Boolean;
   subtype CSR_EOS_SLV_Field is Boolean;
   subtype CSR_OVR_SLV_Field is Boolean;
   subtype CSR_JEOC_SLV_Field is Boolean;
   subtype CSR_JEOS_SLV_Field is Boolean;
   subtype CSR_AWD1_SLV_Field is Boolean;
   subtype CSR_AWD2_SLV_Field is Boolean;
   subtype CSR_AWD3_SLV_Field is Boolean;
   subtype CSR_JQOVF_SLV_Field is Boolean;
   ...
   subtype CCR_DMACFG_Field is Boolean;
   subtype CCR_MDMA_Field is HAL.UInt2;
   subtype CCR_CKMODE_Field is HAL.UInt2;
   subtype CCR_PRESC_Field is HAL.UInt4;
   subtype CCR_VREFEN_Field is Boolean;
   subtype CCR_VSENSESEL_Field is Boolean;
   subtype CCR_VBATSEL_Field is Boolean;
   ...
   type CCR_Register is record
      ...
      --  VREFINT enable
      VREFEN         : CCR_VREFEN_Field := False;
      --  VTS selection
      VSENSESEL      : CCR_VSENSESEL_Field := False;
      --  VBAT selection
      VBATSEL        : CCR_VBATSEL_Field := False;
      --  unspecified

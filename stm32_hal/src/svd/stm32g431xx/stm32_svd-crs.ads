...
package STM32_SVD.CRS is
   ...
   subtype CR_SYNCOKIE_Field is Boolean;
   subtype CR_SYNCWARNIE_Field is Boolean;
   subtype CR_ERRIE_Field is Boolean;
   subtype CR_ESYNCIE_Field is Boolean;
   subtype CR_CEN_Field is Boolean;
   subtype CR_AUTOTRIMEN_Field is Boolean;
   subtype CR_SWSYNC_Field is Boolean;
   subtype CR_TRIM_Field is HAL.UInt7;

   --  CRS control register
   type CR_Register is record
      --  SYNC event OK interrupt enable
      SYNCOKIE       : CR_SYNCOKIE_Field := False;
      --  SYNC warning interrupt enable
      SYNCWARNIE     : CR_SYNCWARNIE_Field := False;
      --  Synchronization or trimming error interrupt enable
      ERRIE          : CR_ERRIE_Field := False;
      --  Expected SYNC interrupt enable
      ESYNCIE        : CR_ESYNCIE_Field := False;
      --  unspecified
      ...
      AUTOTRIMEN     : CR_AUTOTRIMEN_Field := False;
   ...
   subtype CFGR_SYNCPOL_Field is Boolean;
   ...
   type CFGR_Register is record
      ...
      SYNCPOL        : CFGR_SYNCPOL_Field := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype ISR_SYNCOKF_Field is Boolean;
   subtype ISR_SYNCWARNF_Field is Boolean;
   subtype ISR_ERRF_Field is Boolean;
   subtype ISR_ESYNCF_Field is Boolean;
   subtype ISR_SYNCERR_Field is Boolean;
   subtype ISR_SYNCMISS_Field is Boolean;
   subtype ISR_TRIMOVF_Field is Boolean;
   subtype ISR_FEDIR_Field is Boolean;
   ...
   subtype ICR_SYNCOKC_Field is Boolean;
   subtype ICR_SYNCWARNC_Field is Boolean;
   subtype ICR_ERRC_Field is Boolean;
   subtype ICR_ESYNCC_Field is Boolean;
   ...
   type ICR_Register is record
      ...
      SYNCOKC       : ICR_SYNCOKC_Field := False;
      --  SYNC warning clear flag Writing 1 to this bit clears the SYNCWARNF
      --  flag in the CRS_ISR register.
      SYNCWARNC     : ICR_SYNCWARNC_Field := False;

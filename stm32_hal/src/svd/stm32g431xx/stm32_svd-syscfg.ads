...
package STM32_SVD.SYSCFG is
   ...
   subtype MEMRMP_FB_mode_Field is Boolean;
   ...
   type MEMRMP_Register is record
      ...
      FB_mode       : MEMRMP_FB_mode_Field := False;
      --  unspecified
   ...
   subtype CFGR1_BOOSTEN_Field is Boolean;
   subtype CFGR1_ANASWVDD_Field is Boolean;
   subtype CFGR1_I2C_PB6_FMP_Field is Boolean;
   subtype CFGR1_I2C_PB7_FMP_Field is Boolean;
   subtype CFGR1_I2C_PB8_FMP_Field is Boolean;
   subtype CFGR1_I2C_PB9_FMP_Field is Boolean;
   subtype CFGR1_I2C1_FMP_Field is Boolean;
   subtype CFGR1_I2C2_FMP_Field is Boolean;
   subtype CFGR1_I2C3_FMP_Field is Boolean;
   subtype CFGR1_I2C4_FMP_Field is Boolean;
   ...
   type CFGR1_Register is record
      ...
      --  BOOSTEN
      BOOSTEN        : CFGR1_BOOSTEN_Field := False;
      --  GPIO analog switch control voltage selection
      ANASWVDD       : CFGR1_ANASWVDD_Field := False;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  FM+ drive capability on PB6
      I2C_PB6_FMP    : CFGR1_I2C_PB6_FMP_Field := False;
      --  FM+ drive capability on PB6
      I2C_PB7_FMP    : CFGR1_I2C_PB7_FMP_Field := False;
      --  FM+ drive capability on PB6
      I2C_PB8_FMP    : CFGR1_I2C_PB8_FMP_Field := False;
      --  FM+ drive capability on PB6
      I2C_PB9_FMP    : CFGR1_I2C_PB9_FMP_Field := False;
      --  I2C1 FM+ drive capability enable
      I2C1_FMP       : CFGR1_I2C1_FMP_Field := False;
      --  I2C1 FM+ drive capability enable
      I2C2_FMP       : CFGR1_I2C2_FMP_Field := False;
      --  I2C1 FM+ drive capability enable
      I2C3_FMP       : CFGR1_I2C3_FMP_Field := False;
      --  I2C1 FM+ drive capability enable
      I2C4_FMP       : CFGR1_I2C4_FMP_Field := False;
      --  unspecified
   ...
   subtype SCSR_CCMER_Field is Boolean;
   subtype SCSR_CCMBSY_Field is Boolean;

   --  CCM SRAM control and status register
   type SCSR_Register is record
      --  CCM SRAM Erase
      CCMER         : SCSR_CCMER_Field := False;
      --  Read-only. CCM SRAM busy by erase operation
      CCMBSY        : SCSR_CCMBSY_Field := False;
      --  unspecified
   ...
   subtype CFGR2_CLL_Field is Boolean;
   subtype CFGR2_SPL_Field is Boolean;
   subtype CFGR2_PVDL_Field is Boolean;
   subtype CFGR2_ECCL_Field is Boolean;
   subtype CFGR2_SPF_Field is Boolean;

   --  configuration register 2
   type CFGR2_Register is record
      --  Core Lockup Lock
      CLL           : CFGR2_CLL_Field := False;
      --  SRAM Parity Lock
      SPL           : CFGR2_SPL_Field := False;
      --  PVD Lock
      PVDL          : CFGR2_PVDL_Field := False;
      --  ECC Lock
      ECCL          : CFGR2_ECCL_Field := False;
      --  unspecified
      Reserved_4_7  : HAL.UInt4 := 16#0#;
      --  SRAM Parity Flag
      SPF           : CFGR2_SPF_Field := False;
      --  unspecified
      Reserved_9_31 : HAL.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype SWPR_Page0_WP_Field is Boolean;
   subtype SWPR_Page1_WP_Field is Boolean;
   subtype SWPR_Page2_WP_Field is Boolean;
   subtype SWPR_Page3_WP_Field is Boolean;
   subtype SWPR_Page4_WP_Field is Boolean;
   subtype SWPR_Page5_WP_Field is Boolean;
   subtype SWPR_Page6_WP_Field is Boolean;
   subtype SWPR_Page7_WP_Field is Boolean;
   subtype SWPR_Page8_WP_Field is Boolean;
   subtype SWPR_Page9_WP_Field is Boolean;
   subtype SWPR_Page10_WP_Field is Boolean;
   subtype SWPR_Page11_WP_Field is Boolean;
   subtype SWPR_Page12_WP_Field is Boolean;
   subtype SWPR_Page13_WP_Field is Boolean;
   subtype SWPR_Page14_WP_Field is Boolean;
   subtype SWPR_Page15_WP_Field is Boolean;
   subtype SWPR_Page16_WP_Field is Boolean;
   subtype SWPR_Page17_WP_Field is Boolean;
   subtype SWPR_Page18_WP_Field is Boolean;
   subtype SWPR_Page19_WP_Field is Boolean;
   subtype SWPR_Page20_WP_Field is Boolean;
   subtype SWPR_Page21_WP_Field is Boolean;
   subtype SWPR_Page22_WP_Field is Boolean;
   subtype SWPR_Page23_WP_Field is Boolean;
   subtype SWPR_Page24_WP_Field is Boolean;
   subtype SWPR_Page25_WP_Field is Boolean;
   subtype SWPR_Page26_WP_Field is Boolean;
   subtype SWPR_Page27_WP_Field is Boolean;
   subtype SWPR_Page28_WP_Field is Boolean;
   subtype SWPR_Page29_WP_Field is Boolean;
   subtype SWPR_Page30_WP_Field is Boolean;
   subtype SWPR_Page31_WP_Field is Boolean;

   --  SRAM Write protection register 1
   type SWPR_Register is record
      --  Write protection
      Page0_WP  : SWPR_Page0_WP_Field := False;
      --  Write protection
      Page1_WP  : SWPR_Page1_WP_Field := False;
      --  Write protection
      Page2_WP  : SWPR_Page2_WP_Field := False;
      --  Write protection
      Page3_WP  : SWPR_Page3_WP_Field := False;
      --  Write protection
      Page4_WP  : SWPR_Page4_WP_Field := False;
      --  Write protection
      Page5_WP  : SWPR_Page5_WP_Field := False;
      --  Write protection
      Page6_WP  : SWPR_Page6_WP_Field := False;
      --  Write protection
      Page7_WP  : SWPR_Page7_WP_Field := False;
      --  Write protection
      Page8_WP  : SWPR_Page8_WP_Field := False;
      --  Write protection
      Page9_WP  : SWPR_Page9_WP_Field := False;
      --  Write protection
      Page10_WP : SWPR_Page10_WP_Field := False;
      --  Write protection
      Page11_WP : SWPR_Page11_WP_Field := False;
      --  Write protection
      Page12_WP : SWPR_Page12_WP_Field := False;
      --  Write protection
      Page13_WP : SWPR_Page13_WP_Field := False;
      --  Write protection
      Page14_WP : SWPR_Page14_WP_Field := False;
      --  Write protection
      Page15_WP : SWPR_Page15_WP_Field := False;
      --  Write protection
      Page16_WP : SWPR_Page16_WP_Field := False;
      --  Write protection
      Page17_WP : SWPR_Page17_WP_Field := False;
      --  Write protection
      Page18_WP : SWPR_Page18_WP_Field := False;
      --  Write protection
      Page19_WP : SWPR_Page19_WP_Field := False;
      --  Write protection
      Page20_WP : SWPR_Page20_WP_Field := False;
      --  Write protection
      Page21_WP : SWPR_Page21_WP_Field := False;
      --  Write protection
      Page22_WP : SWPR_Page22_WP_Field := False;
      --  Write protection
      Page23_WP : SWPR_Page23_WP_Field := False;
      --  Write protection
      Page24_WP : SWPR_Page24_WP_Field := False;
      --  Write protection
      Page25_WP : SWPR_Page25_WP_Field := False;
      --  Write protection
      Page26_WP : SWPR_Page26_WP_Field := False;
      --  Write protection
      Page27_WP : SWPR_Page27_WP_Field := False;
      --  Write protection
      Page28_WP : SWPR_Page28_WP_Field := False;
      --  Write protection
      Page29_WP : SWPR_Page29_WP_Field := False;
      --  Write protection
      Page30_WP : SWPR_Page30_WP_Field := False;
      --  Write protection
      Page31_WP : SWPR_Page31_WP_Field := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;

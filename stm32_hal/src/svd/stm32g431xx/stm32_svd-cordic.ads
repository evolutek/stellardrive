...
package STM32_SVD.CORDIC is
   ...
   subtype CSR_IEN_Field is Boolean;
   subtype CSR_DMAREN_Field is Boolean;
   subtype CSR_DMAWEN_Field is Boolean;
   subtype CSR_NRES_Field is Boolean;
   subtype CSR_NARGS_Field is Boolean;
   subtype CSR_RESSIZE_Field is Boolean;
   subtype CSR_ARGSIZE_Field is Boolean;
   subtype CSR_RRDY_Field is Boolean;
   ...
   type CSR_Register is record
      ...
      --  IEN
      IEN            : CSR_IEN_Field := False;
      --  DMAREN
      DMAREN         : CSR_DMAREN_Field := False;
      --  DMAWEN
      DMAWEN         : CSR_DMAWEN_Field := False;
      --  NRES
      NRES           : CSR_NRES_Field := False;
      --  NARGS
      NARGS          : CSR_NARGS_Field := False;
      --  RESSIZE
      RESSIZE        : CSR_RESSIZE_Field := False;
      --  ARGSIZE
      ARGSIZE        : CSR_ARGSIZE_Field := False;
      --  unspecified
      Reserved_23_30 : HAL.UInt8 := 16#0#;
      --  RRDY
      RRDY           : CSR_RRDY_Field := False;
   end record

...
package STM32_SVD.VREFBUF is
   ...
   subtype VREFBUF_CSR_ENVR_Field is Boolean;
   subtype VREFBUF_CSR_HIZ_Field is Boolean;
   subtype VREFBUF_CSR_VRR_Field is Boolean;

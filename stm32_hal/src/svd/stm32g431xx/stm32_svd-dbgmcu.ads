...
package STM32_SVD.DBGMCU is
   ...
   subtype CR_DBG_SLEEP_Field is Boolean;
   subtype CR_DBG_STOP_Field is Boolean;
   subtype CR_DBG_STANDBY_Field is Boolean;
   subtype CR_TRACE_IOEN_Field is Boolean;
   subtype CR_TRACE_MODE_Field is HAL.UInt2;

   --  Debug MCU Configuration Register
   type CR_Register is record
      --  Debug Sleep Mode
      DBG_SLEEP     : CR_DBG_SLEEP_Field := False;
      --  Debug Stop Mode
      DBG_STOP      : CR_DBG_STOP_Field := False;
      --  Debug Standby Mode
      DBG_STANDBY   : CR_DBG_STANDBY_Field := False;
      --  unspecified
      Reserved_3_4  : HAL.UInt2 := 16#0#;
      --  Trace pin assignment control
      TRACE_IOEN    : CR_TRACE_IOEN_Field := False;
      --  Trace pin assignment control
   ...
   subtype APB1L_FZ_DBG_TIMER2_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_TIM3_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_TIM4_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_TIM5_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_TIMER6_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_TIM7_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_RTC_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_WWDG_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_IWDG_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_I2C1_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_I2C2_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_I2C3_STOP_Field is Boolean;
   subtype APB1L_FZ_DBG_LPTIMER_STOP_Field is Boolean;

   --  APB Low Freeze Register 1
   type APB1L_FZ_Register is record
      --  Debug Timer 2 stopped when Core is halted
      DBG_TIMER2_STOP  : APB1L_FZ_DBG_TIMER2_STOP_Field := False;
      --  TIM3 counter stopped when core is halted
      DBG_TIM3_STOP    : APB1L_FZ_DBG_TIM3_STOP_Field := False;
      --  TIM4 counter stopped when core is halted
      DBG_TIM4_STOP    : APB1L_FZ_DBG_TIM4_STOP_Field := False;
      --  TIM5 counter stopped when core is halted
      DBG_TIM5_STOP    : APB1L_FZ_DBG_TIM5_STOP_Field := False;
      --  Debug Timer 6 stopped when Core is halted
      DBG_TIMER6_STOP  : APB1L_FZ_DBG_TIMER6_STOP_Field := False;
      --  TIM7 counter stopped when core is halted
      DBG_TIM7_STOP    : APB1L_FZ_DBG_TIM7_STOP_Field := False;
      --  unspecified
      Reserved_6_9     : HAL.UInt4 := 16#0#;
      --  Debug RTC stopped when Core is halted
      DBG_RTC_STOP     : APB1L_FZ_DBG_RTC_STOP_Field := False;
      --  Debug Window Wachdog stopped when Core is halted
      DBG_WWDG_STOP    : APB1L_FZ_DBG_WWDG_STOP_Field := False;
      --  Debug Independent Wachdog stopped when Core is halted
      DBG_IWDG_STOP    : APB1L_FZ_DBG_IWDG_STOP_Field := False;
      --  unspecified
      Reserved_13_20   : HAL.UInt8 := 16#0#;
      --  I2C1 SMBUS timeout mode stopped when core is halted
      DBG_I2C1_STOP    : APB1L_FZ_DBG_I2C1_STOP_Field := False;
      --  I2C2 SMBUS timeout mode stopped when core is halted
      DBG_I2C2_STOP    : APB1L_FZ_DBG_I2C2_STOP_Field := False;
      --  unspecified
      Reserved_23_29   : HAL.UInt7 := 16#0#;
      --  I2C3 SMBUS timeout mode stopped when core is halted
      DBG_I2C3_STOP    : APB1L_FZ_DBG_I2C3_STOP_Field := False;
      --  LPTIM1 counter stopped when core is halted
      DBG_LPTIMER_STOP : APB1L_FZ_DBG_LPTIMER_STOP_Field := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype APB1H_FZ_DBG_I2C4_STOP_Field is Boolean;
   ...
   type APB1H_FZ_Register is record
      ...
      --  DBG_I2C4_STOP
      DBG_I2C4_STOP : APB1H_FZ_DBG_I2C4_STOP_Field := False;
      --  unspecified
   ...
   subtype APB2_FZ_DBG_TIM1_STOP_Field is Boolean;
   subtype APB2_FZ_DBG_TIM8_STOP_Field is Boolean;
   subtype APB2_FZ_DBG_TIM15_STOP_Field is Boolean;
   subtype APB2_FZ_DBG_TIM16_STOP_Field is Boolean;
   subtype APB2_FZ_DBG_TIM17_STOP_Field is Boolean;
   subtype APB2_FZ_DBG_TIM20_STOP_Field is Boolean;
   subtype APB2_FZ_DBG_HRTIM0_STOP_Field is Boolean;
   subtype APB2_FZ_DBG_HRTIM1_STOP_Field is Boolean;
   subtype APB2_FZ_DBG_HRTIM2_STOP_Field is Boolean;
   subtype APB2_FZ_DBG_HRTIM3_STOP_Field is Boolean;
   ...
   type APB2_FZ_Register is record
      ...
      DBG_TIM1_STOP   : APB2_FZ_DBG_TIM1_STOP_Field := False;
      --  unspecified
      Reserved_12_12  : Boolean := False;
      --  TIM8 counter stopped when core is halted
      DBG_TIM8_STOP   : APB2_FZ_DBG_TIM8_STOP_Field := False;
      --  unspecified
      Reserved_14_15  : HAL.UInt2 := 16#0#;
      --  TIM15 counter stopped when core is halted
      DBG_TIM15_STOP  : APB2_FZ_DBG_TIM15_STOP_Field := False;
      --  TIM16 counter stopped when core is halted
      DBG_TIM16_STOP  : APB2_FZ_DBG_TIM16_STOP_Field := False;
      --  TIM17 counter stopped when core is halted
      DBG_TIM17_STOP  : APB2_FZ_DBG_TIM17_STOP_Field := False;
      --  unspecified
      Reserved_19_19  : Boolean := False;
      --  TIM20counter stopped when core is halted
      DBG_TIM20_STOP  : APB2_FZ_DBG_TIM20_STOP_Field := False;
      --  unspecified
      Reserved_21_25  : HAL.UInt5 := 16#0#;
      --  DBG_HRTIM0_STOP
      DBG_HRTIM0_STOP : APB2_FZ_DBG_HRTIM0_STOP_Field := False;
      --  DBG_HRTIM0_STOP
      DBG_HRTIM1_STOP : APB2_FZ_DBG_HRTIM1_STOP_Field := False;
      --  DBG_HRTIM0_STOP
      DBG_HRTIM2_STOP : APB2_FZ_DBG_HRTIM2_STOP_Field := False;
      --  DBG_HRTIM0_STOP
      DBG_HRTIM3_STOP : APB2_FZ_DBG_HRTIM3_STOP_Field := False;
      --  unspecified

...
package STM32_SVD.WWDG is
   ...
   subtype CR_WDGA_Field is Boolean;
   ...
   subtype CFR_EWI_Field is Boolean;
   ...
   subtype SR_EWIF_Field is Boolean;

   --  Status register
   type SR_Register is record
      --  Early wakeup interrupt flag
      EWIF          : SR_EWIF_Field := False;
      --  unspecified

...
--        B_0x3 => 3);
   ...
   -- RCC CFGR SWS modified type
   subtype RCC_CFGR_SWS_Element is Boolean;

   type RCC_CFGR_SWS_Array is array (0 .. 1) of RCC_CFGR_SWS_Element
     with Component_Size => 1, Size => 2;

   type RCC_CFGR_SWS_Field
   ...
   is record
      case As_Array is
         when False =>
            Val : HAL.UInt2;
         when True =>
            Arr : RCC_CFGR_SWS_Array;
      end case;
   end record
     with Unchecked_Union, Size => 2;

   for RCC_CFGR_SWS_Field use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;
   -- RCC CFGR SWS modified type
...
--        B_0xE => 14,
--        B_0xF => 15);
   subtype RCC_CFGR_HPRE_Element is Boolean;

   type RCC_CFGR_HPRE_Array is array (0 .. 3) of RCC_CFGR_HPRE_Element
     with Component_Size => 1, Size => 4;

   type RCC_CFGR_HPRE_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
            Val : HAL.UInt4;
         when True =>
            Arr : RCC_CFGR_HPRE_Array;
      end case;
   end record
     with Unchecked_Union, Size => 4;

   for RCC_CFGR_HPRE_Field use record
      Val at 0 range 0 .. 3;
      Arr at 0 range 0 .. 3;
   end record;
...
--     subtype RCC_CFGR_PPRE1_Field is HAL.UInt3;
   subtype RCC_CFGR_PPRE1_Field is Integer range 0 .. 7
      with Static_Predicate => RCC_CFGR_PPRE1_Field in 0 | 4 .. 7;
   ...
   type RCC_CFGR_Register is record
      ...
      SWS            : RCC_CFGR_SWS_Field := (As_Array => False, Val => 16#1#); -- RM is contradictory here p.289 with p.330 #TODO #FIX
      ...
      --  divided
      HPRE           : RCC_CFGR_HPRE_Field := (As_Array => False, Val => 16#0#); -- HPRE reset value
      --  APB1 prescaler Set and cleared by software to control the division
      --  factor of the APB1 clock (PCLK1). 0xx: HCLK not divided
   ...
   subtype RCC_PLLCFGR_PLLM_Field is HAL.UInt4;
--       (--  PLLM = 1
--        B_0x0,
--        --  PLLM = 2
--        B_0x1,
...
--        B_0x7F => 127);
   subtype RCC_PLLCFGR_PLLN_Element is Boolean;

   type RCC_PLLCFGR_PLLN_Array is array (0 .. 6) of RCC_PLLCFGR_PLLN_Element
     with Component_Size => 1, Size => 7;

   type RCC_PLLCFGR_PLLN_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
            Val : HAL.UInt7;
         when True =>
            Arr : RCC_PLLCFGR_PLLN_Array;
      end case;
   end record
     with Unchecked_Union, Size => 7;

   for RCC_PLLCFGR_PLLN_Field use record
      Val at 0 range 0 .. 6;
      Arr at 0 range 0 .. 6;
   end record;
   ...
   subtype RCC_PLLCFGR_PLLP_Field is Boolean;
--       (--  PLLP = 7
--        B_0x0,
--        --  PLLP = 17
--        B_0x1)
...
--        B_0x3 => 3);
   ...
   subtype RCC_PLLCFGR_PLLQ_Element is Boolean;

   type RCC_PLLCFGR_PLLQ_Array is array (0 .. 1) of RCC_PLLCFGR_PLLQ_Element
     with Component_Size => 1, Size => 2;

   type RCC_PLLCFGR_PLLQ_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
            Val : HAL.UInt2;
         when True =>
            Arr : RCC_PLLCFGR_PLLQ_Array;
      end case;
   end record
     with Unchecked_Union, Size => 2;

   for RCC_PLLCFGR_PLLQ_Field use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;
   ...
   type RCC_PLLCFGR_Register is record
      ...
      PLLN           : RCC_PLLCFGR_PLLN_Field := (As_Array => False, Val => 10#16#);
      --  unspecified
      ...
      --  these bits correctly not to exceed 170 MHz on this domain.
      PLLP           : RCC_PLLCFGR_PLLP_Field := False;
      --  unspecified
      ...
      --  this domain.
      PLLQ           : RCC_PLLCFGR_PLLQ_Field := (As_Array => False, Val => 16#0#);
      --  unspecified
   ...
   type RCC_APB1ENR1_Register is record
      ...
      CRSEN          : Boolean := False;
      --  unspecified
      Reserved_9_9   : Boolean := False;
      --  RTC APB clock enable Set and cleared by software
      RTCAPBEN       : Boolean := True;
      --  Window watchdog clock enable Set by software to enable the window
...
--        B_0x3 => 3);
   ...
   subtype RCC_CCIPR_I2S23SEL_Element is Boolean;

   type RCC_CCIPR_I2S23SEL_Array is array (0 .. 1) of RCC_CCIPR_I2S23SEL_Element
     with Component_Size => 1, Size => 2;

   type RCC_CCIPR_I2S23SEL_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
            Val : HAL.UInt2;
         when True =>
            Arr : RCC_CCIPR_I2S23SEL_Array;
      end case;
   end record
     with Unchecked_Union, Size => 2;

   for RCC_CCIPR_I2S23SEL_Field use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;

   subtype RCC_CCIPR_FDCANSEL_Field is HAL.UInt2;
   ...
   type RCC_CCIPR_Register is record
      ...
      LPTIM1SEL  : Boolean := False;
      --  clock source selection These bits are set and cleared by software to
      --  select the SAI clock source.
      SAI1SEL    : Boolean := False;
      --  clock source selection These bits are set and cleared by software to
      --  select the I2S23 clock source.
      I2S23SEL   : RCC_CCIPR_I2S23SEL_Field := (As_Array => False, Val => 16#0#);
      --  None
      ...
      ADC12SEL   : Boolean := False;
      --  ADC3/4/5 clock source selection These bits are set and cleared by
      --  software to select the clock source used by the ADC345 interface.
      ADC345SEL  : Boolean := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
...
--       with Size => 2;
   ...
   subtype RCC_BDCR_RTCSEL_Element is Boolean;

   type RCC_BDCR_RTCSEL_Field_Array is array (0 .. 1) of RCC_BDCR_RTCSEL_Element
     with Component_Size => 1, Size => 2;

   type RCC_BDCR_RTCSEL_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
         ...
         when True =>
            --  PIF as an array
            Arr : RCC_BDCR_RTCSEL_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 2;
...
--        B_0x3 => 3);
   ...
   for RCC_BDCR_RTCSEL_Field use record
      Val at 0 range 0 .. 1;
      Arr at 0 range 0 .. 1;
   end record;
   ...
   type RCC_BDCR_Register is record
      ...
      --  used to reset them.
      RTCSEL         : RCC_BDCR_RTCSEL_Field := (As_Array => False, Val => 16#0#); -- Somewhat dubious #FIX #TODO
      --  unspecified
   ...
   subtype RCC_CRRCR_HSI48CAL_Field is HAL.UInt9;
   ...
   type RCC_Peripheral is record
      --  Clock control register
      CR         : aliased RCC_CR_Register;
      --  Internal clock sources calibration register
      ICSCR      : aliased RCC_ICSCR_Register;
      --  Clock configuration register
      CFGR       : aliased RCC_CFGR_Register;
      --  PLL configuration register
      PLLCFGR    : aliased RCC_PLLCFGR_Register;
      --  Clock interrupt enable register
      CIER       : aliased RCC_CIER_Register;
      --  Clock interrupt flag register
      CIFR       : aliased RCC_CIFR_Register;
      --  Clock interrupt clear register
      CICR       : aliased RCC_CICR_Register;
      --  AHB1 peripheral reset register
      AHB1RSTR   : aliased RCC_AHB1RSTR_Register;
      --  AHB2 peripheral reset register
      AHB2RSTR   : aliased RCC_AHB2RSTR_Register;
      --  AHB3 peripheral reset register
      AHB3RSTR   : aliased RCC_AHB3RSTR_Register;
      --  APB1 peripheral reset register 1
      APB1RSTR1  : aliased RCC_APB1RSTR1_Register;
      --  APB1 peripheral reset register 2
      APB1RSTR2  : aliased RCC_APB1RSTR2_Register;
      --  APB2 peripheral reset register
      APB2RSTR   : aliased RCC_APB2RSTR_Register;
      --  AHB1 peripheral clock enable register
      AHB1ENR    : aliased RCC_AHB1ENR_Register;
      --  AHB2 peripheral clock enable register
      AHB2ENR    : aliased RCC_AHB2ENR_Register;
      --  AHB3 peripheral clock enable register
      AHB3ENR    : aliased RCC_AHB3ENR_Register;
      --  APB1 peripheral clock enable register 1
      APB1ENR1   : aliased RCC_APB1ENR1_Register;
      --  APB1 peripheral clock enable register 2
      APB1ENR2   : aliased RCC_APB1ENR2_Register;
      --  APB2 peripheral clock enable register
      APB2ENR    : aliased RCC_APB2ENR_Register;
      --  AHB1 peripheral clocks enable in Sleep and Stop modes register
      AHB1SMENR  : aliased RCC_AHB1SMENR_Register;
      --  AHB2 peripheral clocks enable in Sleep and Stop modes register
      AHB2SMENR  : aliased RCC_AHB2SMENR_Register;
      --  AHB3 peripheral clocks enable in Sleep and Stop modes register
      AHB3SMENR  : aliased RCC_AHB3SMENR_Register;
      --  APB1 peripheral clocks enable in Sleep and Stop modes register 1
      APB1SMENR1 : aliased RCC_APB1SMENR1_Register;
      --  APB1 peripheral clocks enable in Sleep and Stop modes register 2
      APB1SMENR2 : aliased RCC_APB1SMENR2_Register;
      --  APB2 peripheral clocks enable in Sleep and Stop modes register
      APB2SMENR  : aliased RCC_APB2SMENR_Register;
      --  Peripherals independent clock configuration register
      CCIPR      : aliased RCC_CCIPR_Register;
      --  RTC domain control register
      BDCR       : aliased RCC_BDCR_Register;
      --  Control/status register
      CSR        : aliased RCC_CSR_Register;
      --  Clock recovery RC register
      CRRCR      : aliased RCC_CRRCR_Register;
      --  Peripherals independent clock configuration register
      CCIPR2     : aliased RCC_CCIPR2_Register;
   end record
     with Volatile;

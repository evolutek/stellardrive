...
package STM32_SVD.GPIO is
   ...
   subtype OTYPER_OT_Element is Boolean;
   ...
   --  IDR array element
   subtype IDR_Element is Boolean;
   ...
   --  ODR array element
   subtype ODR_Element is Boolean;
   ...
   subtype BSRR_BS_Element is Boolean;
   ...
   subtype BSRR_BR_Element is Boolean;
   ...
   subtype LCKR_LCK_Element is Boolean;
   ...
   subtype LCKR_LCKK_Field is Boolean;
   ...
   subtype BRR_BR_Element is Boolean;
